...
This is a set of scripts and protocols to do some offensive countermeausures and active defense against phishers/scammers which uses Telegram chats/channels as part of phishing kits.
